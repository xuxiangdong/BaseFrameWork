	...
	window.onload = one ;  
	 document.onkeydown=keyDownSearch;  
	    ...
	    function login()
	    {
	    	...
	    	$.post("/BaseFrameWork/login",$("#id_login").serializeArray(),function(result){
    ...
    <div class="container">
        <div class="row">
			...
			<div id="errorinfo" style="color: red;height: 20px; margin-bottom: -40px;"></div>
               ...
               <form id="id_login" class="form-horizontal" role="form" name="f" action="/BaseFrameWork/login" method="POST">
